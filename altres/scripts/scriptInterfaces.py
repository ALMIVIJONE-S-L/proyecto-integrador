...
# INFO ADICIONAL PARA EJECUTAR COMADNOS: 2 formas de ejecutar comandos (usando las librerías o os o subprocess)
# EJEMPLOS:
        ...
        def cpFicheros(absRutaFichero):
            ...
            if whereAreYou == 0:
                ...
                if differents != 0: # Importante el !=
                    ...
                    return print(f"[info]: El fichero {os.path.basename(absRutaFichero)} es igual al que hay en {ruta}, por tanto no haré nada.")
            elif whereAreYou != 0:
                os.system(f"cp {absRutaFichero} {ruta}")
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
        ...
        if existeLaLineaEnCrontab != 0:
            ...
            # ENCENDER INTERFAZ (en el caso de que no lo esté)
else:
